...
import com.userservice.services.UserSeviceImpl;
...
class UserServiceImplTest {
	...
	final void testCreateUser() {
		...
		UserDto storedDetails = (UserDto) userService.createUser(userDto).getBody();
	...
	final void testGetUserDetailsByUserId() {
		...
		UserDto userDto = userService.getUserByUserId("edsd3445tcd");
		assertNotNull(userDto);
